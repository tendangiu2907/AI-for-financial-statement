...
# POPPLER_PATH = r"T:\Intern-Orient\AI\proj\poppler-24.08.0\Library\bin"
import os


MODEL_SIGNATURE_PATH = os.path.join("model", "Nhận diện chữ ký.pt")
MODEL_TABLE_TITLE_PATH = os.path.join("model", "best_model_YoLo.pt")
